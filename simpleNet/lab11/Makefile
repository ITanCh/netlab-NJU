all: son/son sip/sip client/app_simple_client server/app_simple_server client/app_stress_client server/app_stress_server client/IM_client server/IM_server 
...
client/IM_client: client/IM_client.c common/seg.o client/stcp_client.o topology/topology.o 
	gcc -Wall -pedantic -std=c99 -g -pthread client/IM_client.c common/seg.o client/stcp_client.o topology/topology.o -o client/IM_client 
...
server/IM_server: server/IM_server.c common/seg.o server/stcp_server.o topology/topology.o 
	gcc -Wall -pedantic -std=c99 -g -pthread server/IM_server.c common/seg.o server/stcp_server.o topology/topology.o -o server/IM_server
